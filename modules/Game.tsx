...
import { getAllAudioNames, getAudioNamesToPlay, getTotalLength, musicUrl, useAllSnippets, useBackgroundMusic } from './audio'
...
function Game() {
    ...
    const [characterSelection, setCharacterSelection] = useLocalStorage<boolean[]>('characterSelection', characters.map(() => false))
    const [isBackgroundMusicPaused, setIsBackgroundMusicPaused] = useLocalStorage<boolean>('backgroundMusic', false)
