...
export default function CharacterSelectionScreen({
    ...
    return <div className={styles.characterSelectionScreen}>
        <header><h1>Rettegés éjszakája<br/>Veszelovszki Edition</h1></header>
        ...
        <nav>
            ...
            <button onClick={() => setIsBackgroundMusicPaused(!isBackgroundMusicPaused)}
                    className={classnames(styles.toggleButton, { [styles.active]: !isBackgroundMusicPaused })}>
